...
public class FMC2 extends JFrame{
	...
	public FMC2(String title, JTextField tf) {
		Connection con = null;
		Statement st = null;
		ResultSet rs = null;
		String s;
		carnumber = tf.getText();
...
//connect your app to mysql database 
		...
		try {
			...
			s = "select carnumber 차량번호, space 자리, intime 입차시간  from car where carnumber like '%" + carnumber +"'";
